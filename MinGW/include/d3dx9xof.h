...
DECLARE_INTERFACE_( ID3DXFile, IUnknown )
{
    ...
    STDMETHOD( CreateEnumObject )( THIS_ LPCVOID, D3DXF_FILELOADOPTIONS,
        interface ID3DXFileEnumObject** ) PURE;
    STDMETHOD( CreateSaveObject )( THIS_ LPCVOID, D3DXF_FILESAVEOPTIONS,
        D3DXF_FILEFORMAT, interface ID3DXFileSaveObject** ) PURE;
    STDMETHOD( RegisterTemplates )( THIS_ LPCVOID, SIZE_T ) PURE;
    STDMETHOD( RegisterEnumTemplates )( THIS_ interface ID3DXFileEnumObject* ) PURE;
};
...
DECLARE_INTERFACE_( ID3DXFileSaveObject, IUnknown )
{
    ...
    STDMETHOD( AddDataObject )( THIS_ REFGUID, LPCSTR, CONST GUID*,
        SIZE_T, LPCVOID, interface ID3DXFileSaveData** ) PURE;
...
DECLARE_INTERFACE_( ID3DXFileEnumObject, IUnknown )
{
    ...
    STDMETHOD( GetChild )( THIS_ SIZE_T, interface ID3DXFileData** ) PURE;
    STDMETHOD( GetDataObjectById )( THIS_ REFGUID, interface ID3DXFileData** ) PURE;
    STDMETHOD( GetDataObjectByName )( THIS_ LPCSTR, interface ID3DXFileData** ) PURE;
};
